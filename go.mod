...
replace github.com/lightningequipment/circuitbreaker/circuitbreakerrpc => ./circuitbreakerrpc

replace go.etcd.io/etcd/api/v3 => go.etcd.io/etcd/api/v3 v3.5.6

replace go.etcd.io/etcd/client/pkg/v3 => go.etcd.io/etcd/client/pkg/v3 v3.5.6

replace go.etcd.io/etcd/client/v3 => go.etcd.io/etcd/client/v3 v3.5.6

replace go.etcd.io/etcd/pkg/v3 => go.etcd.io/etcd/pkg/v3 v3.5.6

replace go.etcd.io/etcd/raft/v3 => go.etcd.io/etcd/raft/v3 v3.5.6

replace go.etcd.io/etcd/server/v3 => go.etcd.io/etcd/server/v3 v3.5.6

replace github.com/lightningnetwork/lnd => github.com/carlakc/lnd v0.17.0-beta.rc2.0.20230913203559-5f65c1ad535b

// LND uses a custom version of protobuf display, we need to use it too to keep dependencies in order.
