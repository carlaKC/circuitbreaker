...
type ServiceClient interface {
	...
	ListReputationThresholds(ctx context.Context, in *ListReputationThresholdsRequest, opts ...grpc.CallOption) (*ListReputationThresholdsResponse, error)
}
...
func (c *serviceClient) ListReputationThresholds(ctx context.Context, in *ListReputationThresholdsRequest, opts ...grpc.CallOption) (*ListReputationThresholdsResponse, error) {
	out := new(ListReputationThresholdsResponse)
	err := c.cc.Invoke(ctx, "/circuitbreaker.Service/ListReputationThresholds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ServiceServer interface {
	...
	ListReputationThresholds(context.Context, *ListReputationThresholdsRequest) (*ListReputationThresholdsResponse, error)
...
func (UnimplementedServiceServer) ListReputationThresholds(context.Context, *ListReputationThresholdsRequest) (*ListReputationThresholdsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListReputationThresholds not implemented")
}
...
func _Service_ListReputationThresholds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListReputationThresholdsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ServiceServer).ListReputationThresholds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/circuitbreaker.Service/ListReputationThresholds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ServiceServer).ListReputationThresholds(ctx, req.(*ListReputationThresholdsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Service_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListReputationThresholds",
			Handler:    _Service_ListReputationThresholds_Handler,
		},
	},
