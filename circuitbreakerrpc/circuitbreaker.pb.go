...
type Forward struct {
	...
	IncomingEndorsed bool        `protobuf:"varint,10,opt,name=incoming_endorsed,json=incomingEndorsed,proto3" json:"incoming_endorsed,omitempty"`
	OutgoingEndorsed bool        `protobuf:"varint,11,opt,name=outgoing_endorsed,json=outgoingEndorsed,proto3" json:"outgoing_endorsed,omitempty"`
	CltvDelta        uint32      `protobuf:"varint,12,opt,name=cltv_delta,json=cltvDelta,proto3" json:"cltv_delta,omitempty"`
}
...
func (x *Forward) GetIncomingEndorsed() bool {
	if x != nil {
...
func (x *Forward) GetOutgoingEndorsed() bool {
	if x != nil {
...
func (x *Forward) GetCltvDelta() uint32 {
	if x != nil {
		return x.CltvDelta
	}
	return 0
...
type ListReputationThresholdsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ListReputationThresholdsRequest) Reset() {
	*x = ListReputationThresholdsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListReputationThresholdsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListReputationThresholdsRequest) ProtoMessage() {}

func (x *ListReputationThresholdsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_circuitbreaker_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListReputationThresholdsRequest.ProtoReflect.Descriptor instead.
func (*ListReputationThresholdsRequest) Descriptor() ([]byte, []int) {
	return file_circuitbreaker_proto_rawDescGZIP(), []int{17}
}

func (x *ListReputationThresholdsRequest) GetAddStartTimeNs() int64 {
	if x != nil {
		return x.AddStartTimeNs
	}
	return 0
...
func (x *ListReputationThresholdsRequest) GetAddEndTimeNs() int64 {
	if x != nil {
		return x.AddEndTimeNs
	}
	return 0
...
type ListReputationThresholdsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Htlcs []*ReputationThreshold `protobuf:"bytes,1,rep,name=htlcs,proto3" json:"htlcs,omitempty"`
}

func (x *ListReputationThresholdsResponse) Reset() {
	*x = ListReputationThresholdsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *ListReputationThresholdsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListReputationThresholdsResponse) ProtoMessage() {}

func (x *ListReputationThresholdsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_circuitbreaker_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListReputationThresholdsResponse.ProtoReflect.Descriptor instead.
func (*ListReputationThresholdsResponse) Descriptor() ([]byte, []int) {
	return file_circuitbreaker_proto_rawDescGZIP(), []int{18}
}

func (x *ListReputationThresholdsResponse) GetHtlcs() []*ReputationThreshold {
	if x != nil {
		return x.Htlcs
	}
	return nil
...
type ReputationThreshold struct {
	...
	ForwardTsNs     uint64      `protobuf:"varint,2,opt,name=forward_ts_ns,json=forwardTsNs,proto3" json:"forward_ts_ns,omitempty"`
	IncomingCircuit *CircuitKey `protobuf:"bytes,3,opt,name=incoming_circuit,json=incomingCircuit,proto3" json:"incoming_circuit,omitempty"`
	OutgoingChannel uint64      `protobuf:"varint,4,opt,name=outgoing_channel,json=outgoingChannel,proto3" json:"outgoing_channel,omitempty"`
	IncomingRevenue float64     `protobuf:"fixed64,5,opt,name=incoming_revenue,json=incomingRevenue,proto3" json:"incoming_revenue,omitempty"`
	InFlightRisk    float64     `protobuf:"fixed64,6,opt,name=in_flight_risk,json=inFlightRisk,proto3" json:"in_flight_risk,omitempty"`
	HtlcRisk        float64     `protobuf:"fixed64,7,opt,name=htlc_risk,json=htlcRisk,proto3" json:"htlc_risk,omitempty"`
	OutgoingRevenue float64     `protobuf:"fixed64,8,opt,name=outgoing_revenue,json=outgoingRevenue,proto3" json:"outgoing_revenue,omitempty"`
	Outcome         uint32      `protobuf:"varint,9,opt,name=outcome,proto3" json:"outcome,omitempty"`
}

func (x *ReputationThreshold) Reset() {
	*x = ReputationThreshold{}
	if protoimpl.UnsafeEnabled {
...
func (x *ReputationThreshold) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ReputationThreshold) ProtoMessage() {}

func (x *ReputationThreshold) ProtoReflect() protoreflect.Message {
	mi := &file_circuitbreaker_proto_msgTypes[19]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ReputationThreshold.ProtoReflect.Descriptor instead.
func (*ReputationThreshold) Descriptor() ([]byte, []int) {
	return file_circuitbreaker_proto_rawDescGZIP(), []int{19}
}

func (x *ReputationThreshold) GetPaymentHash() string {
	if x != nil {
...
func (x *ReputationThreshold) GetForwardTsNs() uint64 {
	if x != nil {
		return x.ForwardTsNs
	}
	return 0
}

func (x *ReputationThreshold) GetIncomingCircuit() *CircuitKey {
	if x != nil {
		return x.IncomingCircuit
	}
	return nil
...
func (x *ReputationThreshold) GetOutgoingChannel() uint64 {
	if x != nil {
...
func (x *ReputationThreshold) GetIncomingRevenue() float64 {
	if x != nil {
...
func (x *ReputationThreshold) GetInFlightRisk() float64 {
	if x != nil {
...
func (x *ReputationThreshold) GetHtlcRisk() float64 {
	if x != nil {
		return x.HtlcRisk
	}
	return 0
...
func (x *ReputationThreshold) GetOutgoingRevenue() float64 {
	if x != nil {
		return x.OutgoingRevenue
	}
	return 0
}

func (x *ReputationThreshold) GetOutcome() uint32 {
	if x != nil {
		return x.Outcome
	}
	return 0
...
var file_circuitbreaker_proto_rawDesc = []byte{
	...
	0x22, 0x8e, 0x04, 0x0a, 0x07, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64, 0x12, 0x1e, 0x0a, 0x0b,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x18, 0x3a, 0x01, 0x2a, 0x22, 0x13, 0x2f, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x65,
	0x66, 0x61, 0x75, 0x6c, 0x74, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x12, 0x64, 0x0a, 0x0a, 0x4c, 0x69,
	0x73, 0x74, 0x4c, 0x69, 0x6d, 0x69, 0x74, 0x73, 0x12, 0x21, 0x2e, 0x63, 0x69, 0x72, 0x63, 0x75,
	0x69, 0x74, 0x62, 0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x4c, 0x69,
	0x6d, 0x69, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x63, 0x69,
	...
	0x0f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x09, 0x12, 0x07, 0x2f, 0x6c, 0x69, 0x6d, 0x69, 0x74, 0x73,
	0x12, 0x91, 0x01, 0x0a, 0x15, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x6f, 0x72, 0x77, 0x61, 0x72, 0x64,
	0x69, 0x6e, 0x67, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x12, 0x2c, 0x2e, 0x63, 0x69, 0x72,
	...
	0x79, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x2d, 0x2e, 0x63, 0x69, 0x72, 0x63, 0x75,
	0x69, 0x74, 0x62, 0x72, 0x65, 0x61, 0x6b, 0x65, 0x72, 0x2e, 0x4c, 0x69, 0x73, 0x74, 0x46, 0x6f,
	...
	,
...
var file_circuitbreaker_proto_goTypes = []interface{}{
	...
	(*ListReputationThresholdsRequest)(nil),  // 18: circuitbreaker.ListReputationThresholdsRequest
	(*ListReputationThresholdsResponse)(nil), // 19: circuitbreaker.ListReputationThresholdsResponse
	(*ReputationThreshold)(nil),              // 20: circuitbreaker.ReputationThreshold
...
var file_circuitbreaker_proto_depIdxs = []int32{
	...
	20, // 11: circuitbreaker.ListReputationThresholdsResponse.htlcs:type_name -> circuitbreaker.ReputationThreshold
	16, // 12: circuitbreaker.ReputationThreshold.incoming_circuit:type_name -> circuitbreaker.CircuitKey
	...
	18, // 20: circuitbreaker.Service.ListReputationThresholds:input_type -> circuitbreaker.ListReputationThresholdsRequest
	...
	19, // 27: circuitbreaker.Service.ListReputationThresholds:output_type -> circuitbreaker.ListReputationThresholdsResponse
...
func file_circuitbreaker_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_circuitbreaker_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListReputationThresholdsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_circuitbreaker_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ListReputationThresholdsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_circuitbreaker_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReputationThreshold); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
